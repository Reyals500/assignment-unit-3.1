...
let favoriteFoods = ['Tacos', 'Sushi', 'Ramen', 'Curry', 'Pizza', 'Fried Rice']
...
console.log('The last animal in the', animalArray, 'is', lastAnimal);
...
let lastAnimalPartTwo = animalArray[animalArray.length - 1];
console.log('The last animal in the', animalArray, 'is', lastAnimalPartTwo);
...
console.log('Added entree to the beginning:', favoriteFoods);
...
let lastColor = colors.pop(3);
console.log('Removed the last color', lastColor);
console.log('Colors we have now', colors);
